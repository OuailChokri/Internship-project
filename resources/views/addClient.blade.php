    ...
    <div class="dropdown-arrow bg-info"></div>
     ...
     <!-- basic form -->
            ...
            <div class="col-lg-12 d-flex justify-content-center ">
                ...
                <h5 class="mb-0 text-capitalize">Nouvelle Client</h5>
            </div>
            <div class="card-body">
            ...
            @csrf
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nom" id="name" placeholder="Entrer le nom" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label text-secondary text-capitalize">Address</label>
                    <input type="text" class="form-control" name="adresse" id="exampleInputEmail1" placeholder="Entrer L'address" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="mobile_number" class="form-label text-secondary text-capitalize">Numéro de téléphone mobile</label>
                    <input type="tel" class="form-control" name="telephone" id="mobile_number" placeholder="Numero de Telephone" required>
                </div>
                <div class="mb-3">
                    <label for="id_card" class="form-label text-secondary text-capitalize">Carte d'identité</label>
                    <input type="text" class="form-control" name="cin" id="id_card" placeholder="Entrer le Cart ID" required>
                </div>
