...
<body>
    ...
    <div class="card" style="width: 100%;">
        <div class="card-header">
            <h5 class="mb-0 text-capitalize">Nouvelle Employé</h5>
        </div>
        <div class="card-body">
        ...
        @csrf
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" id="exampleInputEmail1"  placeholder="Entrer Email" required>
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label text-secondary text-capitalize">password</label>
                <input type="password" name="password" class="form-control" id="exampleInputEmail1"  placeholder="Entrer le password" required>
            </div>
