...
<div class="body">
    ...
    <nav class="mb-3" aria-label="breadcrumb">
        <ol class="breadcrumb d2c_global_breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page">Éditer une Facture</li>
        </ol>
    </nav>

    <!-- Form to edit an existing Facture -->
    <div class="col-lg-12 d-flex justify-content-center">
        <div class="card" style="width: 100%;">
            <div class="card-header">
                <h5 class="mb-0 text-capitalize">Modifier Facture</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('factures.update', $facture->idFacture) }}" method="post">
                    @csrf         
                    <div class="mb-3">
                        <label for="client" class="form-label text-secondary text-capitalize">Client</label>
                        <select class="form-control" name="nomClient" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="dateFacture" id="date_facture" value="{{ $facture->dateFacture }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="montant_total" class="form-label text-secondary text-capitalize">Montant Total</label>
                        <input type="number" step="0.01" class="form-control" name="montantTotal" id="montant_total" value="{{ $facture->montantTotal }}" placeholder="Entrer le montant total" required>
                    </div>
                    <div class="mb-3">
    ...
    <select class="form-control" name="statut" id="statut" required>
        ...
        <option value="impayé" {{ $facture->statut === 'impayé' ? 'selected' : '' }}>Impayé</option>
    </select>
</div>
