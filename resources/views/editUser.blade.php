...
<body>
    ...
    <div class="card" style="width: 100%;">
        <div class="card-header">
            <h5 class="mb-0 text-capitalize">Modifier L'utilisateur</h5>
        </div>
        <div class="card-body">
        ...
        @csrf
            <div class="mb-3">
                ...
                <input type="text" name="nom" class="form-control" id="name" placeholder="Entrer le nom" value="{{$user->name}}" required>
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label text-secondary text-capitalize">Email</label>
                <input type="email" name="email" class="form-control" id="exampleInputEmail1" value="{{$user->email}}" placeholder="Entrer le Role" required>
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label text-secondary text-capitalize">Role</label>
                <input type="text" name="role" class="form-control" id="exampleInputEmail1" value="{{$user->role}}" placeholder="Entrer L'email" disabled="true" required>
            </div>
