    ...
    <div class="dropdown-arrow bg-info"></div>
     ...
     <!-- basic form -->
        ...
        <div class="col-lg-12 d-flex justify-content-center ">
            ...
            <h5 class="mb-0 text-capitalize">Modifier Voiture</h5>
        </div>
        <div class="card-body">
        <form action="{{route('voitures.update',$voiture->idVoiture)}}" method="post">
            @csrf
                <div class="mb-3">
                    <label for="name" class="form-label text-secondary text-capitalize">Nom</label>
                    <input type="text" name="nom" value="{{$voiture->marque}}" class="form-control" id="name" placeholder="Entrer le Nom"required>

                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label text-secondary text-capitalize">Voiture Nombre</label>
                    <input type="text" name="plaque" value="{{$voiture->plaque}}" class="form-control" id="exampleInputEmail1" placeholder="Entrer le Nombre de Voiture" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label text-secondary text-capitalize">Couleur</label>
                    <input type="text" name="couleur" value="{{$voiture->couleur}}" class="form-control" id="exampleInputPassword1" placeholder="Entrer la Couleur" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputurl1" class="form-label text-secondary text-capitalize">année de production</label>
                    <input type="number" name="annee" value="{{$voiture->annee}}" class="form-control" id="exampleInputurl1" placeholder="Entrer L'année de production" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label text-secondary text-capitalize">Date de l'impot</label>
                    <input type="date" name="date_impot" value="{{$voiture->date_impot}}" class="form-control" id="exampleInputPassword1" placeholder="Entrer la date de l'impot" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label text-secondary text-capitalize">Date de l'assurance</label>
                    <input type="date" name="date_assurance" value="{{$voiture->date_assurance}}" class="form-control" id="exampleInputPassword1" placeholder="Entrer la date de l'assurance" required>
                </div>
