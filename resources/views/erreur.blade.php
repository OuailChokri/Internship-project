...
<body>
    ...
    <div class="d2c_error d-flex align-items-center">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 offset-xl-2">
                    <div class="row align-items-center">
                        <div class="col-md-4 d-none d-md-block">
                            <div>
                                <img src="../assets/images/error_image.png" class="w-100" alt="error image">
                            </div>
                        </div>
                        <div class="col-md ps-5">
                        <div>
                            <h1 class="text-primary d2c_error_title fw-bold">403</h1>
                            <h4 class="text-secondary d2c_error_subtitle">Accès non autorisé !</h4>
                            <p class="text-muted d2c_error_description">Désolé, vous n'êtes pas autorisé à accéder à cette page !</p>
                            <a href="{{ url('/') }}" class="px-4 btn btn-primary rounded-pill">Retour à l'accueil</a>
                        </div>
